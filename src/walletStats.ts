...
function categorize(title: string): string {
  ...
  if (["president", "election", "senate", "governor", "congress"].some((k) => t.includes(k))) return "politics";
  if ([" vs ", "spread:", "o/u", "moneyline", "exact score", "inning"].some((k) => t.includes(k))) return "sports";
  return "other";
}
